...
job_name = "SSD_{}_no_dilation".format(resize)
...
#aspect_ratios = [[2, 3], [2], [2, 3], [2, 3], [2, 3], [2, 3], [2, 3]]
# L2 normalize conv4_3.
# TODO(jowos) find out what this normalization does
...
VGGNetBody(net, from_layer='data', fully_conv=True, reduced=True, dilated=False,
