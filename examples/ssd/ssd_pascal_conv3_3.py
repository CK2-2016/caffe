...
min_ratio = 20
max_ratio = 95
# change -2 to -3, so that we only consider intervals from fc7 to pool6 in
# step calculation, and specify the size of conv3_3 and conv4_3  manually
...
min_sizes = [min_dim * 5 / 100., min_dim * 10 / 100.] + min_sizes
max_sizes = [[], []] + max_sizes
aspect_ratios = [[2], [2], [2, 3], [2, 3], [2, 3], [2, 3], [2, 3]]
...
mbox_layers = CreateMultiBoxHead(net, data_layer='data', from_layers=mbox_source_layers,
        ...
        prior_variance=prior_variance, kernel_size=3, pad=1, local_fc=local_fc)
